 ...
 * @author User
 */
public class CreatEvent extends javax.swing.JFrame {

    /**
     * Creates new form CreatEvent
     */
    private int n;
    public CreatEvent(int n) {
        this.n = n; 
    ...
    private void initComponents() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(CreatEvent.class.getResource("/images/smallLogo.PNG")));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreatEvent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreatEvent(1).setVisible(true);
            }
        });
    }
