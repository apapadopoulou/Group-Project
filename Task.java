...
public class Task extends Program {
    ...
    //Importance of a task should be between 1 and 10.
    private int difficulty;
    //Difficulty of a task should be between 1 and 10.
    private String empid;
    //Employee ID for single-employee Tasks.
    private ArrayList<String> empids;
    //Employee IDs ArrayList for Group Tasks.
   ...
   */
    public Task(Date startDate, Date dueDate, String desc,
        int parts, int importance, int difficulty, String empid) {
        super();
        this.desc = desc;
   ...
   */
    public Task(Date startDate, Date dueDate, String desc, int parts,
        int importance, int difficulty, ArrayList<String> empids) {
        super();
        this.desc = desc;
        this.startDate = startDate;
        this.dueDate = dueDate;
	 ...
	 * An option is also offered, in case
